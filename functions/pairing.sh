...
if [ "$TREESCAPS" = "phyml" ]; then
  PAIRM="Pairs-${PAIRINGMANNER}/MSA_${MSAMETHOD}_${GBLOCKS}..PhyML_${MSATRETAG}-${TREESROOT}"
  PAIRL="Pairs-${PAIRINGMANNER}-excluded/MSA_${MSAMETHOD}_${GBLOCKS}..PhyML_${MSATRETAG}${TREESROOT}"
  CAPSM="CAPS-${PAIRINGMANNER}/MSA_${MSAMETHOD}_${GBLOCKS}..PhyML_${MSATRETAG}-${TREESROOT}/Alpha${ALPHA}"
  RESULTS="Results-${PAIRINGMANNER}/MSA_${MSAMETHOD}_${GBLOCKS}..PhyML_${MSATRETAG}-${TREESROOT}/Alpha${ALPHA}"
elif [ "$TREESCAPS" = "external" ]; then
  PAIRM="Pairs-${PAIRINGMANNER}/MSA_${MSAMETHOD}_${GBLOCKS}..TREE_external-${ETREEROOT}"
  PAIRL="Pairs-${PAIRINGMANNER}-excluded/MSA_${MSAMETHOD}_${GBLOCKS}..TREE_external-${ETREEROOT}"
  CAPSM="CAPS-${PAIRINGMANNER}/MSA_${MSAMETHOD}_${GBLOCKS}..TREE_external-${ETREEROOT}/Alpha${ALPHA}"
  RESULTS="Results-${PAIRINGMANNER}/MSA_${MSAMETHOD}_${GBLOCKS}..TREE_external-${ETREEROOT}/Alpha${ALPHA}"
elif [ "$TREESCAPS" = "auto" ]; then
  PAIRM="Pairs-${PAIRINGMANNER}/MSA_${MSAMETHOD}_${GBLOCKS}..TREE_auto"
  PAIRL="Pairs-${PAIRINGMANNER}-excluded/MSA_${MSAMETHOD}_${GBLOCKS}..TREE_auto"
  CAPSM="CAPS-${PAIRINGMANNER}/MSA_${MSAMETHOD}_${GBLOCKS}..TREE_auto/Alpha${ALPHA}"
  RESULTS="Results-${PAIRINGMANNER}/MSA_${MSAMETHOD}_${GBLOCKS}..TREE_auto/Alpha${ALPHA}"
else
